...
export const IncentiveCard: React.FC = () => {
  ...
  return (
    <div
      className="card-pop"
      style={{
        background: 'linear-gradient(130deg, #1565C0 0%, #1976D2 40%, #2196F3 100%)',
        borderRadius: '20px',
        padding: '18px 16px',
        position: 'relative',
        overflow: 'hidden',
        boxShadow: '0 8px 28px rgba(21, 101, 192, 0.40)',
        minHeight: '120px',
        display: 'flex',
    ...
    >
      ...
      >
        ...
        <svg viewBox="0 0 100 110" width="105" height="110" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Box body */}
          <rect x="12" y="48" width="76" height="54" rx="5" fill="#FFC107" />
          {/* Box lid */}
          <rect x="8" y="35" width="84" height="18" rx="4" fill="#FFD54F" />
          {/* Ribbon vertical */}
          <rect x="44" y="35" width="12" height="67" rx="3" fill="#EF5350" />
          {/* Ribbon horizontal on lid */}
          <rect x="8" y="41" width="84" height="12" rx="3" fill="#EF5350" />
          {/* Bow left loop */}
          <ellipse cx="34" cy="33" rx="14" ry="9" fill="#EF5350" transform="rotate(-25 34 33)" />
          {/* Bow right loop */}
          <ellipse cx="66" cy="33" rx="14" ry="9" fill="#EF5350" transform="rotate(25 66 33)" />
          {/* Bow center knot */}
          <circle cx="50" cy="35" r="7" fill="#E53935" />
          {/* Shine on lid */}
      ...
      <div style={{ paddingRight: '100px' }}>
        ...
        {/* Progress text */}
        <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.80)', margin: '0 0 10px', fontWeight: '600' }}>
        ...
        >
          <div
            style={{
              ...
              backgroundColor: isCompleted ? '#69F0AE' : '#FFFFFF',
              borderRadius: '4px',
        ...
        <button
          ...
          style={{
            ...
            gap: '6px',
            backgroundColor: isCompleted ? '#69F0AE' : '#FFFFFF',
            color: isCompleted ? '#1D1D1F' : '#1565C0',
            fontSize: '13px',
            fontWeight: '800',
            border: 'none',
            borderRadius: '20px',
        ...
        >
          {isCompleted ? '🎉 View Reward' : 'View Incentive Details'} <ChevronRight size={15} />
        </button>
      </div>
    </div>
  );
