  ...
  return (
    <div
      style={{
        ...
        padding: '24px 16px',
        background: 'linear-gradient(160deg, #EFF6FF 0%, #DBEAFE 40%, #F0FDF4 100%)',
    ...
    >
      {/* Subtle Light Blue Ambient Orbs */}
      <div style={{
        position: 'absolute',
        top: '-8%',
        left: '10%',
        ...
        height: '360px',
        borderRadius: '50%',
        background: 'radial-gradient(circle, rgba(0, 113, 227, 0.10) 0%, rgba(0,0,0,0) 70%)',
        filter: 'blur(50px)',
        pointerEvents: 'none',
      }} />
      <div style={{
      ...
      <div
        style={{
          ...
          borderRadius: '32px',
          overflow: 'hidden',
          boxShadow: '0 20px 60px rgba(0, 113, 227, 0.12), 0 4px 20px rgba(0, 0, 0, 0.06)',
      ...
      >
        ...
        <div style={{ padding: '24px 24px 28px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ textAlign: 'left' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: 'rgba(0, 113, 227, 0.08)', color: '#0071E3', padding: '4px 10px', borderRadius: '20px', fontSize: '11px', fontWeight: 800, letterSpacing: '0.4px', marginBottom: '8px', border: '1px solid rgba(0,113,227,0.15)' }}>
              ⚡ 10-MIN EXPRESS DISPATCH
            </div>
            <h2 style={{ fontSize: '24px', fontWeight: 900, color: '#0F172A', margin: 0, letterSpacing: '-0.3px', lineHeight: '1.25' }}>
              Groceries delivered in <span style={{ background: 'linear-gradient(135deg, #0071E3 0%, #38BDF8 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 900 }}>minutes</span>
            </h2>
            {step !== 'phone' && (
          ...
          {step === 'phone' && (
            <form onSubmit={handlePhoneSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <button
                ...
                style={{
                  width: '100%',
                  background: isPhoneValid ? 'linear-gradient(135deg, #0071E3 0%, #0058B4 100%)' : '#F1F5F9',
                  ...
                  boxShadow: isPhoneValid ? '0 8px 24px rgba(0, 113, 227, 0.30)' : 'none',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: '8px',
          ...
          {step === 'register' && (
            <form onSubmit={handleRegisterSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <button
                ...
                disabled={busy}
                style={{
                  background: 'linear-gradient(135deg, #0071E3 0%, #0058B4 100%)',
                  color: '#FFFFFF',
                  border: 0,
                  borderRadius: '16px',
                  padding: '14px',
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: isSelected ? '0 4px 12px rgba(0, 113, 227, 0.18)' : '0 1px 2px rgba(0,0,0,0.02)',
                    }}
                  >
