...
export default function FestivalPage() {
  ...
  const rakhiProducts = [
    ...
    { id: 8006, name: "Haldiram's Pure Desi Ghee Kaju Katli 400g", price: 399, mrp: 500, discount: 20, weight: "400 g", image: "fest-mithai.jpg", category: "sweets" },
          ...
          <div className="container" style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: isMobile ? '4px' : '12px' }}>
                {[
                  { name: 'Sambar', img: '/oil-real.jpg' },
                  { name: 'Payasam', img: '/fest-mithai.jpg' },
                  { name: 'Chips', img: '/deal-banner-dryfruits.jpg' },
                ].map((dish, idx) => (
                  <div key={idx} style={{
