...
const CATEGORY_MAP = {
  'snacks-munchies': {
    ...
    catKey: 'snacks',
    isDark: false,
    heroImg: '/category-snacks-feast-hero.png',
  ...
  'dairy-bakery': {
    ...
    catKey: 'dairy',
    isDark: false,
    heroImg: '/dairy-hero-transparent.png',
  ...
  'beverages': {
    ...
    catKey: 'beverages',
    isDark: false,
    heroImg: '/beverages-hero-transparent.png',
  ...
  'staples': {
    ...
    catKey: 'staples',
    isDark: true,
    heroImg: '/staples-hero-cutout.png',
  ...
  'chocolates': {
    ...
    catKey: 'chocolates',
    isDark: true,
    heroImg: '/chocolates-hero-cutout.png',
  ...
  'personal-care': {
    ...
    isDark: true,
    heroImg: '/personal-care-hero-cutout.png',
  ...
  'household': {
    ...
    catKey: 'household',
    isDark: true,
    heroImg: '/household-hero-cutout.png',
  ...
  'produce': {
    ...
    catKey: 'produce',
    isDark: true,
    heroImg: '/fresh-produce-splash-transparent.png',
  ...
  'biscuits': {
    ...
    catKey: 'biscuits',
    isDark: true,
    heroImg: '/biscuits-hero-cutout.png',
  ...
  'electronics': {
    ...
    catKey: 'electronics',
    isDark: true,
    heroImg: '/electronics-hero-cutout.png',
